...
import 'package:eturistickaagencija_mobile/providers/hotel_provider.dart';
import 'package:eturistickaagencija_mobile/widgets/master_screen.dart';
...
class _HotelListScreenState extends State<HotelListScreen> {
  HotelProvider? _productProvider = null;
  ...
  void initState() {
    ...
    super.initState();
    _productProvider = context.read<HotelProvider>();
  ...
  Widget _buildHeader() {
    return Container(
      ...
      child: Text("Hotel", style: TextStyle(color: Colors.grey, fontSize: 40, fontWeight: FontWeight.w600),),
    );
  }
